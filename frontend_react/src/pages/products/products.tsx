        ...
        <section className="promotion">
          ...
          <div className="container promotion-inner">
            ...
            <div className="promotion-content">
              ...
              <p>
                Giảm ngay 20% cho đơn
                hàng đầu tiên.
                <br />
                Áp dụng cho tất cả sản
                phẩm.
              </p>
          ...
          <div className="container about-grid">
            ...
            <div className="about-content">
              ...
              <button
                ...
                onClick={() =>
                  alert(
                    "Pet Corner - Nơi chăm sóc thú cưng"
                  )
                }
              >
        ...
        <section className="newsletter">
          ...
          <div className="container newsletter-inner">
            ...
            <div>
              ...
              <p>
                Đăng ký email để nhận ưu
                đãi và thông tin mới nhất.
              </p>
      ...
      <footer className="footer">
        ...
        <div className="container footer-grid">
          ...
          <div className="footer-brand">
            ...
            <p>
              Nơi mọi người yêu thú cưng
              tìm thấy những sản phẩm tốt
              nhất và dịch vụ tận tâm nhất.
            </p>
